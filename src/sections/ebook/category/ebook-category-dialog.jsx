...
const ICON_OPTIONS = [
  { value: 'solar:mosque-bold-duotone', label: 'Mosque (Tauhid)' },
  { value: 'solar:book-bold-duotone', label: 'Book (Fiqh)' },
  { value: 'solar:history-bold-duotone', label: 'History (Sirah)' },
  ...
  { value: 'solar:lightbulb-bold-duotone', label: 'Lightbulb' },
...
export function EbookCategoryDialog({ open, onClose, onSave, currentCategory }) {
  const defaultValues = useMemo(
    () => ({
      name: currentCategory?.name || '',
      slug: currentCategory?.slug || '',
      description: currentCategory?.description || '',
      icon: currentCategory?.icon || 'solar:book-bold-duotone',
