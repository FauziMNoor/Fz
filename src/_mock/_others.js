...
export const _appInstalled = ['de', 'en', 'fr', 'kr', 'us'].map((code, index) => ({
  id: _mock.id(index),
  ...
  flag: `${CONFIG.assetsDir}/assets/icons/flags/ic-flag-${code}.svg`,
}));

export const _appRelated = ['chrome', 'drive', 'dropbox', 'slack', 'spotify'].map(
  (name, index) => ({
    id: _mock.id(index),
    name: name.charAt(0).toUpperCase() + name.slice(1),
    shortcut: `${CONFIG.assetsDir}/assets/icons/apps/ic-app-${name}.svg`,
    system: (index === 2 && 'Windows') || (index === 4 && 'Windows') || 'Mac',
    price: [0, 0, 0, 0, 0][index],
...
export const _appInvoices = Array.from({ length: 5 }, (_, index) => ({
  ...
  category: ['Android', 'Mac', 'Windows', 'Android', 'Mac'][index],
